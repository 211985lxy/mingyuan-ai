...
const { findFirst, authenticateRequest, authErrorResponse, resolveBoundProject, store } = vi.hoisted(() => ({
  ...
  store: {
    findByExternalRecordId: vi.fn<(...args: unknown[]) => Promise<unknown>>(async () => null),
    findByExternalLeadId: vi.fn<(...args: unknown[]) => Promise<unknown>>(async () => null),
    findByExternalDealId: vi.fn<(...args: unknown[]) => Promise<unknown>>(async () => null),
    findByExternalPaymentId: vi.fn<(...args: unknown[]) => Promise<unknown>>(async () => null),
