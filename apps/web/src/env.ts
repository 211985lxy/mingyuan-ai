...
export const env = createEnv({
  server: {
    ...
    AIM_EVAL_DISABLE_CIRCUIT: z.string().optional(),
    ...
    AIM_AUTONOMY_L0_ENABLED: z.string().optional(),
    AIM_PUBLISH_REMINDER_ENABLED: z.string().optional(),
    ...
    // 注意：env:check 契约按"每行一个键"识别声明，保持一行一变量
    SHANJIAN_APP_KEY: z.string().optional(),
    SHANJIAN_AUTH_TEXT: z.string().optional(),
    ...
    HEYGEN_API_KEY: z.string().optional(), HEYGEN_BASE_URL: z.string().optional(), HEYGEN_MAX_CONCURRENT: z.string().optional(), HEYGEN_WEBHOOK_SECRET: z.string().optional(), HEYGEN_WEBHOOK_URL: z.string().optional(),
    CHANJING_APP_ID: z.string().optional(),
    CHANJING_SECRET_KEY: z.string().optional(),
    CHANJING_BASE_URL: z.string().optional(),
    CHANJING_WEBHOOK_URL: z.string().optional(),
    ...
    DOUYIN_LOGIN_REDIRECT_URI: z.string().optional(),
    ...
    CONTENT_PIPELINE_ENABLED: z.string().optional(),
    INSPIRATION_CAPTURE_ACK_ENABLED: z.string().optional(),
    ...
    FISH_AUDIO_PROXY_URL: z.string().optional(),
    ...
    LARK_CREATOR_METRICS_BASE_TOKEN: z.string().optional(),
    LARK_CREATOR_METRICS_DETAIL_TABLE_ID: z.string().optional(),
    LARK_CREATOR_METRICS_SYNC_LOG_TABLE_ID: z.string().optional(),
    ...
    SMS_PROVIDER: z.string().optional(), // console | aliyun（生产禁用 console）
  ...
  runtimeEnv: {
    ...
    AIM_EVAL_DISABLE_CIRCUIT: process.env.AIM_EVAL_DISABLE_CIRCUIT,
    ...
    AIM_AUTONOMY_L0_ENABLED: process.env.AIM_AUTONOMY_L0_ENABLED,
    AIM_PUBLISH_REMINDER_ENABLED: process.env.AIM_PUBLISH_REMINDER_ENABLED,
    ...
    DOUYIN_LOGIN_REDIRECT_URI: process.env.DOUYIN_LOGIN_REDIRECT_URI,
    ...
    CONTENT_PIPELINE_ENABLED: process.env.CONTENT_PIPELINE_ENABLED,
    INSPIRATION_CAPTURE_ACK_ENABLED: process.env.INSPIRATION_CAPTURE_ACK_ENABLED,
    ...
    FISH_AUDIO_PROXY_URL: process.env.FISH_AUDIO_PROXY_URL,
    ...
    LARK_CREATOR_METRICS_BASE_TOKEN: process.env.LARK_CREATOR_METRICS_BASE_TOKEN,
