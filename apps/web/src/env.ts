...
export const env = createEnv({
  server: {
    ...
    HEYGEN_API_KEY: z.string().optional(), HEYGEN_BASE_URL: z.string().optional(), HEYGEN_MAX_CONCURRENT: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    HEYGEN_API_KEY: process.env.HEYGEN_API_KEY, HEYGEN_BASE_URL: process.env.HEYGEN_BASE_URL, HEYGEN_MAX_CONCURRENT: process.env.HEYGEN_MAX_CONCURRENT,
