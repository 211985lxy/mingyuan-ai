...
function DailyReportHero({ report }: { report: TopicDailyReport }) {
  return (
...
function DailyReportEvidence({ report }: { report: TopicDailyReport }) {
  return (
...
function DailyReportExecution({ report }: { report: TopicDailyReport }) {
...
function DailyReportWorkshop({ report }: { report: TopicDailyReport }) {
  return (
    <Card className="border-primary/10 bg-card">
      <CardHeader className="pb-3">
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
        <DailyReportEvidence report={report} />
        <div className="space-y-4">
          <DailyReportExecution report={report} />
          <DailyReportWorkshop report={report} />
        </div>
      </div>
    </div>
  )
