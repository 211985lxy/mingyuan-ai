...
import { fetchAimWeeklyReview, type AimWeeklyBusinessReview, type TaskAttributionInsight } from "@/lib/api/aim-weekly-review"
...
export function ProjectWeeklyBusinessReview({ projectId }: { projectId: string }) {
  ...
  return (
    <div className="border-b px-3 py-2 sm:px-5">
      <WeeklyBusinessReview review={review} taskInsights={taskInsights} />
