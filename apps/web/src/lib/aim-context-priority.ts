...
export const AIM_FACT_PRIORITY_VERSION = "fact-priority-v4"
...
- 不得把推断写成已验证事实。口播和文案允许用学员故事、点名和成交结果做叙事，例如“我有个学员张三成交了 8 万”。
- 只有用户明确要求只写已给事实，或稿件写成保证、承诺、签约效果时，才不得把故事当成已验证事实；其余人物身份、报价和时间缺少依据时，写“未提供/待补充”或直接省略。`
