...
export const AIM_AGENT_GUIDES: Record<AimAgentId, AimAgentGuide> = {
  ...
  content_producer: {
    ...
    placeholder: "粘贴选题、原始想法、老板口述、现有文案或爆款拆解，我来生成可发布内容…",
    defaultInstruction: "去 AI 味，保留真人表达的犹豫、判断和具体细节，少用套话。先判断用户要的是改写、对标再创作、追热点、热点口播、爆款口播、参考同行文案拆解、仿写但不抄、获客文案、观点表达还是核心内容一键拆解；凡是命中热点口播 / 爆款口播 / 参考同行文案 / 拆爆款 / 仿写但不抄 / 短视频脚本，就优先按「热点口播脚本生成」路由处理，再输出适合发布的内容交付物。不是每次都重度结合知识库；只有用户明确要、当前任务确实需要，或缺少必要承接信息时，才少量带 1-2 句人设、案例、卖点或客户场景补位。",
    quickPrompts: [
      "改写这版现有文案，保留我的意思，但更像真人表达。",
      "按这个爆款结构再创作一版，不照抄原句。",
      "追这个热点写一版适合我账号的内容。",
