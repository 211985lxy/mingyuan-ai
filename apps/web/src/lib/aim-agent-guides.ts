...
export const AIM_AGENT_GUIDES: Record<AimAgentId, AimAgentGuide> = {
  ...
  business_diagnosis: {
    ...
    scenarios: ["对标选题池", "按目的出题", "筛高潜", "会议提炼"],
    inputTemplate: BASIC_INPUT_TEMPLATE,
