...
- 分析注意：视频号 followingCount 可能为 0（平台不公开），跳过“关注比”指标，不影响核心评分`,
  douyin: `\n\n## 平台特征（抖音）
- 推荐机制：纯算法推荐，去中心化流量分配。注意抖音已调整权重：收藏为第一权重，其次是复访率（复看率）和铁粉互动率，最后才是点赞；完播率不再是核心考察指标。长视频完播率天然偏低，但靠高收藏、高复访与铁粉互动同样能获得推荐，不能用完播率评判长视频质量。
- 互动模式：点赞/评论/分享/收藏四维互动，其中收藏（可持续停留）与复访是当前核心权重，铁粉互动率次之，点赞权重最低
