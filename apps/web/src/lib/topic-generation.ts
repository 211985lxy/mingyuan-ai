...
import { buildTopicSystemPrompt, buildTopicUserPrompt, truncateTopicSourceContent } from "@/lib/topic-generation/prompts"
import type { RecommendationMode, TopicGenerationInput, TopicGenerationResult } from "@/lib/topic-generation/contracts"
...
function revisionAdviceFor(
  ...
  const weakest = weakestDimension(breakdown)
  if (verdict === undefined || weakest === null) {
    return "补充客户原话、案例或数据后再评估。"
  }
