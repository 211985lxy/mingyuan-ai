...
const REFERENCE_WORDS = [
  "这篇", "这版", "这个文案", "这个稿", "这篇文案", "这段话", "这段文案",
  "上面那个", "上面这条", "刚才那个", "刚那条", "第一条", "第二条", "上一版",
]
...
const FORMAL_DELIVERY_WORDS = [
  "生成", "输出", "写一版", "给我一版", "写一条", "出一条", "写一篇", "写个", "起草", "创作",
  "完整方案", "完整报告", "资产包", "100条", "发布计划", "交付", "直接输出", "完整质检",
]
