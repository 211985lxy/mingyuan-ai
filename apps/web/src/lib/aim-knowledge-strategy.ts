...
export const KNOWLEDGE_STRATEGY_PROFILES: Record<ResolvedKnowledgeStrategy, KnowledgeStrategyProfile> = {
  ...
  hot_topic: {
    ...
    maxBlockChars: 3000,
    maxEntryChars: 600,
    categoryBoost: { hot_topic: 1.5, benchmark_reference: 1.5, user_insight: 1.2, product_usp: 1.1, customer_pain: 1.1 },
    label: "热点创作",
  ...
  persona: {
    ...
    maxBlockChars: 5000,
    maxEntryChars: 1000,
    categoryBoost: { boss_experience: 1.3, positioning_material: 1.3, project_case: 1.25, product_usp: 1.2, customer_pain: 1.2 },
    label: "人设型",
