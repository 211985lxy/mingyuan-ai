...
export const CONTENT_PRODUCER_SKILLS: AimWorkbenchSkill[] = [
  {
    id: "traffic_funnel",
    label: "流量漏斗",
    description: "主打停留、完播、转发，钩子和节奏优先。",
    prompt: [
      "请基于当前素材，按「流量漏斗」目标写一条可拍摄的短视频口播文案。",
      "本轮优先级：前 3 秒强钩子、持续小冲突/反差、高完播节奏；传播优先于成交。",
      "默认输出一版完整口播正文（可直接录），不要写成摘要，不要停在半句话。",
      "开头用具体场景、反差或利益点抓住停留；中间只推一个主判断；结尾给轻承接，不要硬广。",
  ...
  },
  {
    id: "lead_acquisition",
    label: "线索获客",
    description: "主打评论、私信、预约，结尾承接优先。",
    prompt: [
      "请基于当前素材，按「线索获客」目标写一条可拍摄的短视频口播文案。",
      "本轮优先级：点出目标客户真实问题 → 给可执行判断/方法 → 自然引导评论、私信或预约。",
      "默认输出一版完整口播正文（可直接录），不要写成摘要，不要停在半句话。",
      "承接动作要具体、可执行、不夸大承诺；适合谁、不适合谁要说清楚。",
      "像真人面对镜头说话，短句为主，禁止营销黑话。",
    ].join("\n"),
    agentId: "content_producer",
    group: "内容目的",
  },
  {
    id: "general_story",
    label: "通用故事",
    description: "人设信任、来时路与置顶故事口播，不强行推成交。",
    prompt: [
      "请基于当前素材，按「通用故事」目标写一条可拍摄的短视频口播文案。",
      "本轮优先级：真实经历/转折/现场细节 → 个人判断 → 让观众觉得「这个人值得信」；不强行推产品成交。",
      "若用户要人设故事、来时路或置顶视频：先核对素材是否覆盖经历与成就、低谷与转折、顿悟、当前产品/服务、目标用户与卡点、标志性结果/案例；缺的地方标注待补充，有材料就直接写成口播，不要另开一套智能体流程。",
      "用户明确要置顶视频时，输出「来时路总结」（150 字内）+ 逐句口播正文（可附简短配图建议）；否则默认只输出一版完整口播正文。",
      "默认输出一版完整口播正文（可直接录），不要写成摘要，不要停在半句话。",
      "用第一人称讲故事，保留具体时间、地点、冲突或代价；结尾可落到价值观或轻行动，不要硬广。",
      "像真人面对镜头说话，短句为主，禁止营销黑话。",
    ].join("\n"),
    agentId: "content_producer",
    group: "内容目的",
