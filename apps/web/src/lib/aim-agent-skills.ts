...
export const CONTENT_PRODUCER_SKILLS: AimWorkbenchSkill[] = [
  ...
  GENERAL_STORY_SKILL,
  {
    id: "batch_script_studio",
    label: "批量文案工作室",
    description: "粘贴多条文案，提取结构 → 批量生成新文案，一步到位。",
    prompt: "",
    agentId: "content_producer",
    group: "批量文案",
...
export const CONTENT_RETRO_SKILLS: AimWorkbenchSkill[] = [
  ...
  {
    id: "find_pattern_and_actions",
    label: "找规律定动作",
    description: "对比多条已发布数据找出可复用规律，并给本周能落地动作。",
    prompt: "请基于当前内容和已登记的多条发布数据，找出真正有效的内容规律（哪些选题类型、开头方式、内容角度稳定拿到结果，哪些反复无效），再给 1-3 条本周能落地的具体动作（每条说明为什么做、先做哪一步、做完看哪个指标）。只用真实数据支撑，样本不足直接说样本不足；不要用行业常识凑结论，不要给方向性口号，不要重写文案。",
    agentId: "content_retro",
    group: "规律沉淀",
  },
]
