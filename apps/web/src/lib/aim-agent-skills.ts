...
export const WORK_EDITOR_SKILLS: AimWorkbenchSkill[] = [
  ...
  {
    id: "trim_forbidden_words",
    label: "修剪违禁词",
    description: "改掉违禁/敏感/易限流表述，输出可发正文。",
    prompt: [
      "请对当前成稿做违禁词与敏感表达修剪，直接输出修订后的完整可发正文。",
      "重点处理：绝对化承诺、夸大疗效/收益、违规限流高风险用语、敏感或易招审核表述。",
      "替换成更安全、仍自然的说法；保留作者立场、关键事实和真实数据，不要整篇重写跑题。",
      "若几乎没有风险，先用一两句话说明，再原样输出正文。不要只列词表不给成稿。",
    ].join(""),
    agentId: "work_editor",
    group: "作品编辑",
  },
