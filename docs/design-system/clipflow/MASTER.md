...
- `BRANDING-GUIDELINES.md` contains the 明远AIM / 明远先生 品牌色彩与 UI 设计规范。
- Use that document for brand colors, logo SVG specs, theme classes, button/card behaviors, and Chinese typography rules.
